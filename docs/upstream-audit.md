...
| Collections and comparison | `ReactiveChange`, `ReactiveChangeSet`, collection-change observation, count helpers, ordered/chained comparers | Observable collection records and JavaScript comparators; DynamicData itself is a separate library |
